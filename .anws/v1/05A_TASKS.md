...
- [x] **T1.2.2** [REQ-003, REQ-006]: 实现网站卡片组件
...
- [x] **T1.2.3** [REQ-002, REQ-004, REQ-005]: 实现横向卡片滑动页
...
- [x] **T1.2.5** [REQ-001, REQ-003, REQ-008]: 补齐 UI 组件测试
...
- [x] **T1.3.2** [REQ-001, REQ-002, REQ-008]: 完成性能与可访问性检查
...
- [x] **T1.3.3** [REQ-001, REQ-002, REQ-006]: 准备 E2E 冒烟测试材料
...
- [x] **INT-S3** [MILESTONE]: S3 集成验证 — Event Ready
